...
/**
 * Represents a house block resource with specific properties such as maximum storage,
 * interval between resource generation, and quantity produced per generation.
 * Extends the {@link ResourcesType} class.
 */
public class HouseBlockResource extends ResourcesType {

    /**
     * Constructs a HouseBlockResource with the specified parameters.
     *
     ...
     */
    public HouseBlockResource(String name, int maxResources, int intervalBetweenResourceGeneration, int quantityProduced) {
        super(name, maxResources, intervalBetweenResourceGeneration, quantityProduced);
    }

    /**
     * Returns a string representation of the house block resource, including its properties.
     *
