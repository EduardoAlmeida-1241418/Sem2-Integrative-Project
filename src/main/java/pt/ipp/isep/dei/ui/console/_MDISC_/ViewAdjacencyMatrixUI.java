...
/**
 * User interface class to display the adjacency matrix of connectivity between stations.
 * Implements Runnable for execution of adjacency matrix viewing logic.
 */
public class ViewAdjacencyMatrixUI implements Runnable {
    ...
    /**
     * Constructs a ViewAdjacencyMatrixUI and initializes its controller.
     *
    ...
    /**
     * Runs the UI process to show the adjacency matrix.
     * Validates input data, allows train type filtering, then prints the adjacency matrix.
     */
    @Override
    public void run() {
        ...
        int[][] matrix = controller.buildAdjacencyMatrix();
