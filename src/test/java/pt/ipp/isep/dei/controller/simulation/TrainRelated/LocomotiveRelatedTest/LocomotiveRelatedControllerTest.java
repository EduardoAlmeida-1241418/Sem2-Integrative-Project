package pt.ipp.isep.dei.controller.simulation.TrainRelated.LocomotiveRelatedTest;
...
/**
 * Unit tests for the LocomotiveRelatedController class.
 */
public class LocomotiveRelatedControllerTest {
    ...
    void testSetAndGetSimulation() {
        LocomotiveRelatedController controller = new LocomotiveRelatedController();
